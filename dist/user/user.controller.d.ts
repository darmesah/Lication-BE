...
export declare class UserController {
    ...
    getCertificateApplication(req: any, certificateApplicationId: string): Promise<{
        message: string;
        certificateApplication: import("mongoose").Document<unknown, {}, import("../database/interface").IUserCertificateApplication> & import("../database/interface").IUserCertificateApplication & {
            _id: import("mongoose").Types.ObjectId;
        };
    }>;
